...
import { WishlistServiceProvider } from './wishlist-service';
...
describe('Provider: Wishlist Service', () => {
    ...
    it('should be able to add a single product to product array', inject([WishlistServiceProvider], (wishlistService) => {
    ...
    it('should not add a product to wishlist if it already exists in the wishlist', inject([WishlistServiceProvider], (wishlistService) => {
...
it('should remove a product from wishlist when delete function called', inject([WishlistServiceProvider], (wishlistService) => {
